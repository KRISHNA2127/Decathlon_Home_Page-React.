...
// Creating the context that will be used throughout the app
const ShopContext = createContext();

// Provider component that wraps your app and makes the shop context available to any child component that calls useShop()
